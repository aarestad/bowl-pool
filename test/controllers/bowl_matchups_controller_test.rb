...
class BowlMatchupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bowl_matchup" do
    assert_difference('BowlMatchup.count') do
      post bowl_matchups_url, params: { bowl_matchup: { away_team: @bowl_matchup.away_team, bowl_game: @bowl_matchup.bowl_game, home_team: @bowl_matchup.home_team, home_team_point_spread: @bowl_matchup.home_team_point_spread, year: @bowl_matchup.year } }
    end
  ...
  test "should update bowl_matchup" do
    patch bowl_matchup_url(@bowl_matchup), params: { bowl_matchup: { away_team: @bowl_matchup.away_team, bowl_game: @bowl_matchup.bowl_game, home_team: @bowl_matchup.home_team, home_team_point_spread: @bowl_matchup.home_team_point_spread, year: @bowl_matchup.year } }
